...
movingObject.prototype.drawBody = function(ctx){
	ctx.beginPath();
	ctx.arc(this.pos[0], this.pos[1], this.RADIUS * this.TRANSFORM, 0, 2 * Math.PI, false);
	ctx.fillStyle = this.FILL_COLOR;
	ctx.fill();

	if (this.LINE_WIDTH){
		ctx.lineWidth = this.LINE_WIDTH * this.TRANSFORM;
...
movingObject.prototype.isDead = function(){
	return this.dead;
}
